    ...
    <h2>Типы аргументов и возвращаемоно значения</h2>
        <p>
            C версии PHP 5, допускается указывать типы аргументов (объекты, массивы, интерфейсы, функции обратного вызова).
             В PHP 7 количесвто допустимых типов рассширено булевым bool, целочисленным int, вещественным float и строковым
            string типами. Кроме того позволяет задавать тип возвращаемого функцией значение который указывается через двоеточие.
        </p>
